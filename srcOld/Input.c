...
void Input_HandleEvents(void)
{
    ...
    for (int i = 0; i < DEF_INPUT_KEYCOUNT; i++)
    {
        if (State->Input.Keys[i].Key) // check only recently used keys
        {
            if (State->Input.Keys[i].IsDown && !State->Input.Keys[i].WasDown)
            {
                ...
                SN_Log(LOGLEVEL_DEBUG, "INPUT: Key[%d] IsDown[%d] WasDown[%d]", State->Input.Keys[i].Key,
    ...
    if (State->Input.Mouse.Left.IsDown && !State->Input.Mouse.Left.WasDown)
    {
        ...
        SN_Log(LOGLEVEL_DEBUG, "INPUT: Mouse[LMB] IsDown[%d] WasDown[%d]",
    ...
    if (State->Input.Mouse.Right.IsDown && !State->Input.Mouse.Right.WasDown)
    {
        ...
        SN_Log(LOGLEVEL_DEBUG, "INPUT: Mouse[RMB] IsDown[%d] WasDown[%d]",
    ...
    if (State->Input.Mouse.Middle.IsDown && !State->Input.Mouse.Middle.WasDown)
    {
        ...
        SN_Log(LOGLEVEL_DEBUG, "INPUT: Mouse[MMB] IsDown[%d] WasDown[%d]",
    ...
    if (State->Input.Mouse.X1.IsDown && !State->Input.Mouse.X1.WasDown)
    {
        ...
        SN_Log(LOGLEVEL_DEBUG, "INPUT: Mouse[X1] IsDown[%d] WasDown[%d]",
    ...
    if (State->Input.Mouse.X2.IsDown && !State->Input.Mouse.X2.WasDown)
    {
        ...
        SN_Log(LOGLEVEL_DEBUG, "INPUT: Mouse[X2] IsDown[%d] WasDown[%d]",
        ...
        for (int i = 0; i < DEF_INPUT_CONTROLLERS; i++)
        {
            if (State->Input.Controllers[i].Connected)
            {
                if (SDL_GameControllerGetAttached(State->Input.Controllers[i].Controller) == SDL_FALSE)
                {
                    ...
                    SDL_memset(&State->Input.Controllers[i], 0, sizeof(SN_Controller));
                    SN_Log(LOGLEVEL_INFO, "INPUT: Controller[%d] Disconnected", i);
                    break;
                }
                ...
                if (State->Input.Controllers[i].A.IsDown && !State->Input.Controllers[i].A.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[A] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].B.IsDown && !State->Input.Controllers[i].B.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[B] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].X.IsDown && !State->Input.Controllers[i].X.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[X] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].Y.IsDown && !State->Input.Controllers[i].Y.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[Y] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].Back.IsDown && !State->Input.Controllers[i].Back.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[Back] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].Guide.IsDown && !State->Input.Controllers[i].Guide.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[Guide] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].Start.IsDown && !State->Input.Controllers[i].Start.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[Start] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].LeftStick.IsDown && !State->Input.Controllers[i].LeftStick.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[LeftStick] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].RightStick.IsDown && !State->Input.Controllers[i].RightStick.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[RightStick] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].LeftShoulder.IsDown && !State->Input.Controllers[i].LeftShoulder.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[LeftShoulder] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].RightShoulder.IsDown && !State->Input.Controllers[i].RightShoulder.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[RightShoulder] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].DPadUp.IsDown && !State->Input.Controllers[i].DPadUp.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[DPadUp] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].DPadDown.IsDown && !State->Input.Controllers[i].DPadDown.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[DPadDown] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].DPadLeft.IsDown && !State->Input.Controllers[i].DPadLeft.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[DPadLeft] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].DPadRight.IsDown && !State->Input.Controllers[i].DPadRight.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[DPadRight] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].Misc1.IsDown && !State->Input.Controllers[i].Misc1.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[Misc1] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].Paddle1.IsDown && !State->Input.Controllers[i].Paddle1.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[Paddle1] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].Paddle2.IsDown && !State->Input.Controllers[i].Paddle2.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[Paddle2] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].Paddle3.IsDown && !State->Input.Controllers[i].Paddle3.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[Paddle3] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].Paddle4.IsDown && !State->Input.Controllers[i].Paddle4.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[Paddle4] IsDown[%d] WasDown[%d]",
                ...
                if (State->Input.Controllers[i].TouchPad.IsDown && !State->Input.Controllers[i].TouchPad.WasDown)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Btn[TouchPad] IsDown[%d] WasDown[%d]",
    ...
    while (SDL_PollEvent(&Event))
    {
        switch (Event.type)
        {
            ...
            {
                State->Running = 0;
                SN_Log(LOGLEVEL_DEBUG, "EVENT: Quit");
            } break;
            ...
            case SDL_WINDOWEVENT:
            {
                ...
                switch (Event.window.event)
                {
                    ...
                    {
                        SN_Log(LOGLEVEL_DEBUG, "EVENT: Window Shown");
                    } break;

                    case SDL_WINDOWEVENT_HIDDEN:
                    {
                        SN_Log(LOGLEVEL_DEBUG, "EVENT: Window Hidden");
                    } break;

                    case SDL_WINDOWEVENT_EXPOSED:
                    {
                        SN_Log(LOGLEVEL_DEBUG, "EVENT: Window Exposed");
                    ...
                    {
                        SN_Log(LOGLEVEL_DEBUG, "EVENT: Window Moved");
                    } break;
                    case SDL_WINDOWEVENT_SIZE_CHANGED:
                    {
                        SN_Log(LOGLEVEL_DEBUG, "EVENT: Window Size Changed");
                    } break;

                    case SDL_WINDOWEVENT_MINIMIZED:
                    {
                        SN_Log(LOGLEVEL_DEBUG, "EVENT: Window Minimized");
                    ...
                    {
                        SN_Log(LOGLEVEL_DEBUG, "EVENT: Window Maximized");
                        State->Window.Maximized = 1;
                    } break;

                    case SDL_WINDOWEVENT_RESTORED:
                    {
                        SN_Log(LOGLEVEL_DEBUG, "EVENT: Window Restored");
                        State->Window.Minimized = 0;
                    ...
                    {
                        SN_Log(LOGLEVEL_DEBUG, "EVENT: Window Mouse Enter");
                        State->Window.MouseFocus = 1;
                    } break;

                    case SDL_WINDOWEVENT_LEAVE:
                    {
                        SN_Log(LOGLEVEL_DEBUG, "EVENT: Window Mouse Leave");
                        State->Window.MouseFocus = 0;
                    } break;

                    case SDL_WINDOWEVENT_FOCUS_GAINED:
                    {
                        SN_Log(LOGLEVEL_DEBUG, "EVENT: Window KB Focus Gained");
                        State->Window.KeyboardFocus = 1;
                    } break;

                    case SDL_WINDOWEVENT_FOCUS_LOST:
                    {
                        SN_Log(LOGLEVEL_DEBUG, "EVENT: Window KB Focus Lost");
                        State->Window.KeyboardFocus = 0;
                    } break;

                    case SDL_WINDOWEVENT_CLOSE:
                    {
                        SN_Log(LOGLEVEL_DEBUG, "EVENT: Window Close");
                        State->Running = 0;
                    } break;
                }
            } break;
            ...
            case SDL_KEYDOWN:
            {
                ...
                if (!KeyFound)
                {
                    SN_Log(LOGLEVEL_WARN, "INPUT: Ran out of Key slots!");
                }
            ...
            case SDL_KEYUP:
            {
                ...
                if (!KeyFound)
                {
                    SN_Log(LOGLEVEL_WARN, "INPUT: Got keyup message but key wasnt down! Key[%d]",
            ...
            case SDL_TEXTINPUT:
            {
                SN_Log(LOGLEVEL_DEBUG, "EVENT: TextEdit Event (%s)", Event.edit.text);
            } break;
            ...
            case SDL_MOUSEWHEEL:
            {
                if (Event.wheel.y > 0)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: MouseWheel UP");
                }
                else if (Event.wheel.y < 0)
                {
                    State->Input.Mouse.MouseWheel = MW_DOWN;
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: MouseWheel DOWN");
                }
                else if (Event.wheel.x < 0)
                {
                    State->Input.Mouse.MouseWheel = MW_LEFT;
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: MouseWheel LEFT");
                }
                else if (Event.wheel.x > 0)
                {
                    State->Input.Mouse.MouseWheel = MW_RIGHT;
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: MouseWheel RIGHT");
                }
            } break;
            ...
            case SDL_MOUSEMOTION:
            {
                if (State->Window.MouseFocus)
                {
                    ...
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Mouse X[%d] Y[%d]", State->Input.Mouse.X, State->Input.Mouse.Y);
                }
            } break;
            ...
            case SDL_JOYDEVICEADDED:
            {
                ...
                for (int i = 0; i < DEF_INPUT_CONTROLLERS; i++)
                {
                        ...
                        !State->Input.Controllers[i].Connected)
                    {
                        ...
                        if (SDL_IsGameController(Event.cdevice.which))
                        {
                            ...
                            SN_Log(LOGLEVEL_INFO, "INPUT: Controller[%d] Connected", i);
                            ...
                            for (int j = 0; j < DEF_INPUT_CONTROLLERS; j++)
                            {
                                    ...
                                    State->Input.Controllers[i].Controller == State->Input.Controllers[j].Controller)
                                {
                                    ...
                                    SDL_memset(&State->Input.Controllers[j], 0, sizeof(SN_Controller));
                                    SN_Log(LOGLEVEL_INFO, "INPUT: Controller[%d] Duplicate Removed", j);
                                }
                            }
                        ...
                        {
                            SN_Log(LOGLEVEL_ERROR, "INPUT: Gamepad not recognized.");
                            break;
                        }
                    }
                }
                ...
                if (!SlotFound)
                {
                    SN_Log(LOGLEVEL_ERROR, "INPUT: Out of controller slots");
                }
            ...
            case SDL_CONTROLLERBUTTONUP:
            {
                ...
                {
                    SN_Log(LOGLEVEL_DEBUG, "INPUT: Controller[%d] Axis[%d] Value[%d]", Event.jdevice.which, Event.jaxis.axis, Event.jaxis.value);
                }
            } break;

            default:
            {
                SN_Log(LOGLEVEL_DEBUG, "EVENT: Unhandled Event[%u]", Event.type);
            } break;
